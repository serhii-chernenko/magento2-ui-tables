  ...
  return uiCollection.extend({
    defaults: {
      ...
      components: {
        ...
        table: {
          ...
          cell: {
            default: {
              component: 'Chernenko_Tables/js/view/listing/table/cell',
              template: 'Chernenko_Tables/listing/table/cell/default'
            },
            details: {
              component: 'Chernenko_Tables/js/view/listing/table/cell',
              template: 'Chernenko_Tables/listing/table/cell/details'
            },
            actions: {
              component: 'Chernenko_Tables/js/view/listing/table/cell',
              templates: {
                desktop: 'Chernenko_Tables/listing/table/cell/actions/desktop',
    ...
    mediaCheck() {
      if (!this.mediaBreakpoint) {
        if (this.debug) {
          throw new Error('Set value for the mediaBreakpoint property!');
        }
